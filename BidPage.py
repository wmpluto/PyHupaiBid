...
class BidPage():
    ...
    def set_zero(self):
        x, y = auto.position()
        self.zero = (x, y)
        self.left_area = (LEFT_AREA_DELTA[0] + x, LEFT_AREA_DELTA[1] + y, LEFT_AREA_DELTA[2], LEFT_AREA_DELTA[3])
        self.right_area = (RIGHT_AREA_DELTA[0] + x, RIGHT_AREA_DELTA[1] + y, RIGHT_AREA_DELTA[2], RIGHT_AREA_DELTA[3])

        self.custom_add_price_input_pos = (CUSTOM_ADD_PRICE_INPUT_POS_DELTA[0] + x, CUSTOM_ADD_PRICE_INPUT_POS_DELTA[1] + y)
        self.rise_price_button_pos = (RISE_PRICE_BUTTON_POS_DELTA[0] + x, RISE_PRICE_BUTTON_POS_DELTA[1] + y)
